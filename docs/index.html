    ...
    <header class="header">
      ...
      <nav class="container--pall flex flex-jc-sb flex-ai-c">
        <a href="/" class="header__logo">
          <img src="/assets/images/circle_brb_logo.png" alt="Binangonan Rural Bank">
        </a>
    ...
    <div class="feature container">
      <div class="feature__item">
        <div class="feature__icon">
          <img src="/assets/images/featureicon1.png">
        </div>
      ...
      <div class="feature__item">
        <div class="feature__icon">
          <img src="/assets/images/featureicon2.png">
        </div>
        <div class="feature__desc">
          <h1>Agricultural</h1>
          <p>Loans given to farmers and other entrepreneurs under the stated classification</p>
      ...
      <div class="feature__item">
        <div class="feature__icon">
          <img src="/assets/images/featureicon3.png">
        </div>
        <div class="feature__desc">
          <h1>Agricultural</h1>
          <p>Loans given to farmers and other entrepreneurs under the stated classification</p>
      ...
      <div class="feature__item">
        <div class="feature__icon">
          <img src="/assets/images/featureicon4.png">
        </div>
        <div class="feature__desc">
          <h1>Agricultural</h1>
          <p>Loans given to farmers and other entrepreneurs under the stated classification</p>
